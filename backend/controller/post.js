...
const updatePost = async(req, res, next) => {
    try {
        ...
        res.status(200).json({code: 200, status: true, mesaage: "Poast updated successfully", data: { post }});
...
const deletePost = async(req, res, next) => {
    try {
        ...
        res.status(200).json({code: 200, status: true, mesaage: "Post deleted successfully"});
    } catch (error) {
        next(error)
    }
};
...
const getPosts = async(req, res, next) => {
    try {
        ...
        res.status(200).json({code: 200, status: true, mesaage: "Get post list successfully", data: { posts, total, pages }});
...
const getPost = async(req, res, next) => {
    try {
        ...
        res.status(200).json({code: 200, status: true, mesaage: "Get post successfully", data: { post }});        
    } catch (error) {
        next(error);
    }
};
